...
Run: `docker run --rm -v <input_folder>:/input_folder -v <output_folder>:/output_folder -v <meta_output_folder>:/meta_output_folder hbpmip/hierarchizer:1.3.7 <incoming_dataset> [options]`
...
```
  docker run --rm \
    ...
    hbpmip/hierarchizer:1.3.7 MyDataset --type DICOM
```
